...
function ProductCard({ name, image, price }: IProduct) {
  ...
  return (
    <div className="flex flex-col gap-2 justify-between h-full w-full items-center bg-white  rounded-t-lg">
      <Image
        src={image}
        width={100}
        height={200}
        alt={name}
        className="w-full h-44 border-b border-darkText rounded-t-lg"
      />
