...
function Footer() {
  ...
  return (
    <div className="h-auto bg-terracota flex flex-col gap-3 justify-between items-center text-whiteText text-xs font-imprima p-4 md:flex-row md:h-48 md:justify-between md:text-sm ">
