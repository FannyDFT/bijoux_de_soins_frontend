...
function Appointment() {
  return (
    <div className="h-96 flex flex-col-reverse  justify-between px-0 font-ibarra text-2xl text-darkText bg-background opacity-80 sm:flex sm:flex-row sm:px-48 ">
      <div className=" flex flex-col items-center sm:flex sm:items-start pb-6 sm:pt-14 text-lg sm:text-2xl">
      ...
      <div className="relative -top-6 flex justify-center">
        <Image
          ...
          height={307}
          alt="photo institut"
          className="object-cover border border-darkText p-4 bg-white h-[200px] sm:h-[307px] w-[260px] sm:w-[365px]"
        />
      </div>
    </div>
  );
